...
class login(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_7 = wx.StaticText(self.panel_5, wx.ID_ANY, _("Username"))
        self.combo_box_1 = wx.ComboBox(self.panel_5, wx.ID_ANY, choices=[_("Select"), _("admin"), _("teacher")], style=wx.CB_READONLY|wx.CB_DROPDOWN)
        self.label_8 = wx.StaticText(self.panel_5, wx.ID_ANY, _("Password"))
        self.text_ctrl_1 = wx.TextCtrl(self.panel_5, wx.ID_ANY, "", style=wx.TE_PASSWORD)
        self.button_1 = wx.Button(self.panel_5, wx.ID_ANY, _("Cancel"))
        self.button_2 = wx.Button(self.panel_5, wx.ID_ANY, _("Login"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Login            SmartSchool"))
