...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Sun Sep 11 13:03:21 2016
#
...
class student_profie(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_13 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Year"))
        self.label_14 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Stadard"))
        ...
        self.combo_box_class = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY | wx.CB_SORT)
        self.label_16 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Division"))
        self.label_17 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Student List"))
        ...
        self.combo_box_name = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=[""], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN)
        self.bitmap_photo = wx.BitmapButton(self.panel_1, wx.ID_ANY, wx.Bitmap("/home/ghssvythiri/Desktop/browse.jpg", wx.BITMAP_TYPE_ANY))
        self.static_line_1 = wx.StaticLine(self.panel_1, wx.ID_ANY)
        self.button_add = wx.Button(self.panel_1, wx.ID_ANY, _("Add New Student"))
        self.static_line_3 = wx.StaticLine(self.panel_1, wx.ID_ANY)
        self.label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Roll No"))
        self.label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Name"))
        self.label_3 = wx.StaticText(self.panel_1, wx.ID_ANY, _("UID"))
        ...
        self.label_4 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Gender"))
        self.label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Date of Birth"))
        self.label_6 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Category"))
        self.combo_box_gender = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=[_("Select"), _("M"), _("F"), _("N")], style=wx.CB_DROPDOWN | wx.CB_DROPDOWN | wx.CB_READONLY | wx.CB_SORT)
        ...
        self.label_7 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Religion"))
        self.label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Caste"))
        self.label_9 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Language"))
        ...
        self.label_10 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Father"))
        self.label_11 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Mother"))
        self.label_12 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Mobile"))
        ...
        self.label_18 = wx.StaticText(self.panel_1, wx.ID_ANY, _("Email"))
        ...
        self.button_close = wx.Button(self.panel_1, wx.ID_ANY, _("&Close"))
        self.button_delete = wx.Button(self.panel_1, wx.ID_ANY, _("&Delete"))
        self.button_save = wx.Button(self.panel_1, wx.ID_SAVE, "")
        ...
        self.Bind(wx.EVT_TEXT, self.on_name_edit, self.combo_box_name)
        self.Bind(wx.EVT_COMBOBOX, self.on_student_list, self.combo_box_name)
    ...
    def __do_layout(self):
        ...
        grid_sizer_2.Add(self.combo_box_name, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def on_class(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_class' not implemented!"
        event.Skip()

    def on_div(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_div' not implemented!"
        event.Skip()

    def on_name_edit(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_name_edit' not implemented!"
        event.Skip()

    def on_student_list(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_student_list' not implemented!"
        event.Skip()

    def on_photo(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_photo' not implemented!"
        event.Skip()

    def on_name_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_name_text' not implemented!"
        event.Skip()

    def on_uid_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_uid_enter' not implemented!"
        event.Skip()

    def on_uid_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_uid_text' not implemented!"
        event.Skip()

    def on_gender__change(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_gender__change' not implemented!"
        event.Skip()

    def on_category_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_category_enter' not implemented!"
        event.Skip()

    def on_category(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_category' not implemented!"
        event.Skip()

    def on_religion_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_religion_text' not implemented!"
        event.Skip()

    def on_caste_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_caste_enter' not implemented!"
        event.Skip()

    def on_caste_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_caste_text' not implemented!"
        event.Skip()

    def on_language_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_language_enter' not implemented!"
        event.Skip()

    def on_langauge_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_langauge_text' not implemented!"
        event.Skip()

    def on_father_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_father_enter' not implemented!"
        event.Skip()

    def on_father_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_father_text' not implemented!"
        event.Skip()

    def on_mother_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_mother_enter' not implemented!"
        event.Skip()

    def on_other_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_other_text' not implemented!"
        event.Skip()

    def on_mobile_enter(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_mobile_enter' not implemented!"
        event.Skip()

    def on_mobile_text(self, event):  # wxGlade: student_profie.<event_handler>
        print "Event handler 'on_mobile_text' not implemented!"
        event.Skip()
